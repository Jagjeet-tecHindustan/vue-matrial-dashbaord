      ...
      <div class="form-header blue accent-1">
        ...
        <form>
            ...
            <div class="md-form">
                ...
                <input type="password" id="materialFormCardConfirmEx" class="form-control">
                <label for="materialFormCardConfirmEx" class="font-weight-light">Confirm your password</label>
            </div>

            <div class="text-center py-4 mt-3">
                <button class="btn" style="background-color:#2BBBAD" type="submit">Register</button>
            </div>
        </form>
        <!-- Material form register -->
...
.md-form .prefix.active {
  /* Form icon color when icon is active */
